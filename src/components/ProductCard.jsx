...
const ProductCard = ({product}) => {
  ...
  return (
    <div className='bg-white'>
        <div className=" aspect-[5/6] p-2 rounded-md bg-boxBgClr">
        ...
        <article className="">
            ...
            <div className="flex gap-1 items-center">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99001 2.67508C9.36334 1.77758 10.6367 1.77758 11.01 2.67508L12.745 6.84758L17.2483 7.20841C18.2183 7.28591 18.6117 8.49591 17.8725 9.12924L14.4417 12.0684L15.4892 16.4626C15.715 17.4092 14.6858 18.1567 13.8558 17.6501L10 15.2951L6.14417 17.6501C5.31417 18.1567 4.28501 17.4084 4.51084 16.4626L5.55834 12.0684L2.12751 9.12924C1.38834 8.49591 1.78167 7.28591 2.75167 7.20841L7.25501 6.84758L8.99001 2.67508Z" fill="#FBBF24"/>
                </svg>
                <p>{avgStar}</p>
                <p>({count})</p>
            </div>
